...
| `GET /saude?verificar=supabase` | Também testa a `SUPABASE_SERVICE_ROLE_KEY` no projeto e diz tipo, tamanho, se tem espaço ou aspas, e o status e a mensagem do Supabase — nenhum trecho da chave. Uma `sb_secret_` certa tem 41 caracteres e recebe 200. |
